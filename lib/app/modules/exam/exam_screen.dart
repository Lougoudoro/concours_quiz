...
class ExamScreen extends StatelessWidget {
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          if (controller.isTimeUp.value) {
            return _buildTimeUpOverlay(context, controller);
          }
  ...
  Widget _buildTimeUpOverlay(BuildContext context, ExamController controller) {
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.timer_off_rounded,
                size: 64, color: AppTheme.rougeTerre),
            const SizedBox(height: 20),
            ...
            Text(
              'Le temps imparti pour cet examen est terminé. Tes réponses ont été soumises automatiquement.',
  ...
  Widget _buildHeader(BuildContext context, ExamController controller) {
    final isLow = controller.remainingSeconds.value <= 60;
    final timerColor = isLow ? AppTheme.rougeTerre : AppTheme.vertFaso;
      ...
      child: Column(children: [
        Row(children: [
          ...
          Container(
              ...
              decoration: BoxDecoration(
                  color: isLow
                      ? AppTheme.rougeTerre.withOpacity(0.12)
                      : AppTheme.getSurfaceCardActive(
                          Theme.of(context).brightness == Brightness.dark),
                  borderRadius: BorderRadius.circular(20)),
              child: Row(children: [
                Icon(isLow ? Icons.timer_off_rounded : Icons.timer_outlined,
                    color: timerColor, size: 16),
                const SizedBox(width: 5),
                Obx(() => Text(controller.remainingFormatted,
                    style: TextStyle(
                        color: timerColor,
                        fontSize: 14,
        ...
        Row(children: [
          ...
          const Spacer(),
          Obx(() => Text(
              '${(controller.progressValue * 100).toStringAsFixed(0)}%',
              style: TextStyle(
                  fontSize: 12,
                  color: Theme.of(context).textTheme.bodyMedium!.color,
                  fontWeight: FontWeight.w500))),
  ...
  Widget _buildQuestionText(BuildContext context, ExamController controller) {
  ...
  Widget _buildAnswerOptions(BuildContext context, ExamController controller) {
  ...
  Widget _buildCheckbox(BuildContext context, ExamController controller,
  ...
  Widget _buildJustification(BuildContext context, ExamController controller) {
    return Container(
      width: double.infinity,
  ...
  Widget _buildFooter(BuildContext context, ExamController controller) {
    return Container(
  ...
  void _showQuitDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Ta progression pour cet examen sera perdue.',
            style: TextStyle(
                color: Theme.of(context).textTheme.bodyMedium!.color)),
        actions: [
          TextButton(
